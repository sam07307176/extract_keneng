...
def testIntent():
    # GOODS
    print("[TEST] GOODS")
    inputLIST = ['PChome','coupon','淘寶','露天','後三碼','末三碼','賣貨便','我要取貨','我要領貨','我要取包裹','我要領包裹','名字號碼都對','我的後三碼是','我要領取網購','請問到貨了嗎','我全部都要領取','我電話末三碼是','我找不到我的包裹','可以幫我找後三碼包裹嗎','蝦皮、露天、PChome、coupon、淘寶']
    testLoki(inputLIST, ['GOODS'])
    print("")
